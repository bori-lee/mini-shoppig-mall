...
function fncAddProduct(){
 ...
 $(function() {
	...
	//==> 1 과 3 방법 조합 : $("tagName.className:filter함수") 사용함.	
	 $( "button.ct_btn01:contains('등록')" ).on("click" , function() {
		fncAddProduct();
	});
	
	 $("button.ct_btn01:contains('취소')").on("click", function(){
			$("form")[0].reset();
		});
	 ...
	 $("#calendar").on('click', function(){
		...
		$("#fileName").on("click", function(){
			...
			$("fileForm").attr("method" , "POST").attr("action" , "/product/requestupload1").submit();
		});
  ...
  <!-- form Start /////////////////////////////////////-->
	...
	<div class="form-group">
		    <div class="col-sm-offset-4  col-sm-4 text-center">
			  ...
			  <a class="ct_btn01" href="#" role="button">취소</a>
		    </div>
		  </div>
		</form>
		<!-- form Start /////////////////////////////////////-->
